...
from coffice.tools import float_is_zero
from coffice.tools import float_compare, float_round, float_repr
from coffice.tools.misc import formatLang, format_date
...
class AccountBankStatementLine(models.Model):
    ...
    def _check_amount(self):
        for line in self:
            ...
            # so that user can enter/import the exact bank statement they have received from their bank in Coffice
