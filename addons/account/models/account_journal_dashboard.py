...
from coffice import models, api, _, fields
from coffice.osv import expression
from coffice.release import version
from coffice.tools import DEFAULT_SERVER_DATE_FORMAT as DF, safe_eval
from coffice.tools.misc import formatLang, format_date as coffice_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                activities.append({
                    ...
                    'date': coffice_format_date(self.env, activity.get('date_deadline'))
                })
