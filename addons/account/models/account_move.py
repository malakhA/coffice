...
from coffice.exceptions import RedirectWarning, UserError, ValidationError
from coffice.tools import float_is_zero, float_compare, safe_eval, date_utils, email_split, email_escape_char, email_re
from coffice.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_coffice_invoice(self):
        """ This computes the reference based on the Coffice format.
    ...
    def _get_invoice_reference_coffice_partner(self):
        """ This computes the reference based on the Coffice format.
