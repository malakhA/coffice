coffice.define('account.upload.bill.mixin', function (require) {
"use strict";
...
coffice.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
coffice.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
