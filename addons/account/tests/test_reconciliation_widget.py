...
import time
import requests
from coffice.addons.account.tests.test_reconciliation import TestReconciliation

_logger = logging.getLogger(__name__)


@coffice.tests.tagged('post_install', '-at_install')
@coffice.tests.common.at_install(False)
@coffice.tests.common.post_install(True)
