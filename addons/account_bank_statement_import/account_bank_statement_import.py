...
from coffice.addons.base.models.res_bank import sanitize_account_number
...
class AccountBankStatementImport(models.TransientModel):
    ...
    def import_file(self):
        ...
        for data_file in self.attachment_ids:
            ...
            # Try to find the currency and journal in coffice
                ...
                - bank statements data: list of dict containing (optional items marked by o) :
                    ...
                    - 'transactions': list of dict containing :
                        ...
                        -o 'account_number': string
                            Will be used to find/create the res.partner.bank in coffice
                        -o 'note': string
