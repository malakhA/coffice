...
from coffice import api, http, SUPERUSER_ID, _
from coffice.exceptions import AccessDenied
from coffice.http import request
from coffice import registry as registry_get

from coffice.addons.auth_signup.controllers.main import AuthSignupHome as Home
from coffice.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
