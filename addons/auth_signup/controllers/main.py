...
from coffice.addons.auth_signup.models.res_users import SignupError
from coffice.addons.web.controllers.main import ensure_db, Home
from coffice.addons.base_setup.controllers.main import BaseSetup
