...
from coffice.tests.common import TransactionCase, can_import
from coffice.modules.module import get_module_resource
from coffice.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('coffice.addons.base_import.models.base_import')
