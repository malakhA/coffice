...
from coffice.exceptions import UserError
from coffice.modules import load_information_from_description_file
from coffice.tools import convert_file, exception_to_unicode
from coffice.tools.osutil import tempdir
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Coffice Studio app."))
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import coffice.modules.module as module
                try:
                    coffice.addons.__path__.append(module_dir)
                    ...
                    coffice.addons.__path__.remove(module_dir)
