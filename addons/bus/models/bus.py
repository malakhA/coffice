...
import coffice
from coffice import api, fields, models, SUPERUSER_ID
from coffice.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with coffice.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not coffice.multi_process or coffice.evented:
