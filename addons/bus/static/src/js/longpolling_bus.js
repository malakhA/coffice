coffice.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether coffice is focused or not
     *
     * @returns {boolean}
     */
    isCofficeFocused: function () {
        return this._isCofficeFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isCofficeFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isCofficeFocused);
        }
    },
    /**
