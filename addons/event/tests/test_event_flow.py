...
from coffice.addons.event.tests.common import TestEventCommon
from coffice.exceptions import ValidationError, UserError, AccessError
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.event_0.write({'registration_ids': [(0, 0, {'partner_id': self.user_eventuser.partner_id.id})]})
        self.patcher = patch('coffice.addons.event.models.event.fields.Datetime', wraps=Datetime)
