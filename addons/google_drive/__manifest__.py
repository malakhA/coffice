...

{
    ...
    'description': """
Integrate google document to COffice record.
============================================

This module allows you to integrate google documents to any of your COffice record quickly and easily using OAuth 2.0 for Installed Applications,
