...
from coffice.exceptions import AccessError, ValidationError, UserError
from coffice.tools import mute_logger, test_reports

from coffice.addons.hr_holidays.tests.common import TestHrHolidaysBase
