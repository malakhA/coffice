...
import coffice
from coffice import api, models, registry, exceptions
from coffice.addons.base.models.ir_http import RequestUID, ModelConverter
from coffice.addons.base.models.qweb import QWebException
from coffice.http import request
from coffice.osv import expression
from coffice.tools import config, ustr, pycompat
...
class IrHttp(models.AbstractModel):
    ...
    def _geoip_resolve(cls):
        if 'geoip' not in request.session:
            record = {}
            if coffice._geoip_resolver and request.httprequest.remote_addr:
                record = coffice._geoip_resolver.resolve(request.httprequest.remote_addr) or {}
    ...
    def _postprocess_args(cls, arguments, rule):
        ...
        except coffice.exceptions.MissingError:
