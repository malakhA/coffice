...
from coffice.addons.hw_drivers.controllers.driver import event_manager, Driver, PPDs, conn, printers, cups_lock, iot_devices
...
def print_star_error(deviceId):
    ...
    error_page = (
        ...
        "http://www.coffice.com"  # TODO: Replace URL
        "\x0A\x0A"
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected COffice instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
