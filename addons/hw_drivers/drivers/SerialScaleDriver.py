...
from coffice.addons.hw_drivers.controllers.driver import event_manager
from coffice.addons.hw_drivers.drivers.SerialBaseDriver import SerialDriver, SerialProtocol, serial_connection


_logger = logging.getLogger(__name__)

# Only needed to ensure compatibility with older versions of COffice
ACTIVE_SCALE = None
...
# Ensures compatibility with older versions of COffice
