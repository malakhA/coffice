...
from coffice.tools import float_repr
from coffice.exceptions import UserError, ValidationError
from coffice.addons.base.models.ir_mail_server import MailDeliveryException
        ...
        for invoice in invoices_to_export:
            ...
            if len(invoice.commercial_partner_id.l10n_it_pa_index or '') == 6:
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by Coffice, you can download the document and send it on your own."))
                )
