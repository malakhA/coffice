...
from coffice import _, api, exceptions, fields, models, tools, registry, SUPERUSER_ID
from coffice.osv import expression

from coffice.tools import pycompat, ustr
from coffice.tools.misc import clean_context, split_every
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_post(self, *,
        ...
        if values['author_id'] and values['message_type'] != 'notification' and not self._context.get('mail_create_nosubscribe'):
            # if self.env['res.partner'].browse(values['author_id']).active:  # we dont want to add cofficebot/inactive as a follower
    ...
    def message_post_with_view(self, views_or_xmlid, **kwargs):
        ...
        try:
            from coffice.addons.http_routing.models.ir_http import slug
            values['slug'] = slug
        except ImportError:
