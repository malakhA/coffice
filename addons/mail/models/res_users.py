...
from coffice import _, api, exceptions, fields, models, modules
from coffice.addons.base.models.res_users import is_selection_groups
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        ('inbox', 'Handle in Coffice')],
        'Notification', required=True, default='email',
        help="Policy on how to handle Chatter notifications:\n"
             "- Handle by Emails: notifications are sent to your email address\n"
             "- Handle in Coffice: notifications appear in your Coffice Inbox")
