...
from coffice import api, release, SUPERUSER_ID
from coffice.exceptions import UserError
from coffice.models import AbstractModel
from coffice.tools.translate import _
from coffice.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Coffice's publisher warranty server to check the
