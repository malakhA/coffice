coffice.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isCofficebotAuthor()) {
            return '/mail/static/src/img/cofficebot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or Cofficebot messages
     * (note: Cofficebot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isCofficebotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If Cofficebot is the author (default author for transient messages),
     * returns 'Cofficebot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is CofficeBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isCofficebotAuthor: function () {
        return this._serverAuthorID &&
            this._serverAuthorID[0] === this.call('mail_service', 'getCofficebotID')[0];
    },
    /**
