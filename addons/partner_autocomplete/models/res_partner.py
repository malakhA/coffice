...
import logging
import json
from coffice import api, fields, models, exceptions, _
from coffice.addons.iap import jsonrpc
from requests.exceptions import ConnectionError, HTTPError
from coffice.addons.iap.models.iap import InsufficientCreditError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://partner-autocomplete.coffice.com'
