coffice.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    QUnit.module('partner_autocomplete', {
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "coffice.com/logo.png" ? "cofficebase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getCofficeSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getCofficeSuggestions(value);
                    },
        ...
        beforeEach: function () {
            enrichData = {
                ...
                partner_gid: 1,
                website: "coffice.com",
                comment: "Comment on Coffice",
                street: "40 Chaussée de Namur",
                city: "Ramillies",
                zip: "1367",
                phone: "+1 650-691-3277",
                email: "info@coffice.com",
                vat: "BE0477472701",
            };
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "coffice")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "coffice.com/logo.png"
                    || route === "data:image/png;base64,cofficebase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "coffice");
            ...
            assert.strictEqual($input.val(), "Coffice", "Input value should have been updated to \"Coffice\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "coffice.com", "website value should have been updated to \"coffice.com\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing coffice letters again");
