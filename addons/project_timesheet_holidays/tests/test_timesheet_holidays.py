...
from coffice import fields, SUPERUSER_ID

from coffice.tests import common, new_test_user
from coffice.addons.hr_timesheet.tests.test_timesheet import TestCommonTimesheet
