...
from coffice import api, fields, models, _, SUPERUSER_ID
from coffice.exceptions import UserError
from coffice.osv import expression
from coffice.tools.float_utils import float_compare, float_round, float_is_zero
        ...
        if self.product_qty < self._origin.product_qty:
            warning_mess = {
                ...
                'message' : _("By changing this quantity here, you accept the "
                              "new quantity as complete: Coffice will not "
