...
from coffice import api, fields, models, SUPERUSER_ID, _
from coffice.osv import expression
from coffice.tools import DEFAULT_SERVER_DATETIME_FORMAT
from coffice.tools.float_utils import float_compare, float_is_zero, float_round
from coffice.exceptions import UserError
from coffice.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Coffice will automatically pre-fill the detailed "
