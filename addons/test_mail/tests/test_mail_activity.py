...
from coffice import exceptions, tests
from coffice.addons.test_mail.tests.common import BaseFunctionalTest
from coffice.addons.test_mail.models.test_mail_models import MailTestActivity
