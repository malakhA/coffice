...
from coffice.addons.test_mail.tests import common
from coffice.addons.test_mail.tests.common import mail_new_test_user
from coffice.exceptions import AccessError, except_orm, ValidationError, UserError
from coffice.tools import mute_logger, formataddr
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('coffice.addons.base.models.ir_model', 'coffice.models')
    ...
    @mute_logger('coffice.addons.base.models.ir_model', 'coffice.models', 'coffice.models.unlink')
...
class TestChannelFeatures(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('coffice.addons.mail.models.mail_mail', 'coffice.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('coffice.addons.mail.models.mail_channel', 'coffice.models.unlink')
    ...
    @mute_logger('coffice.models.unlink')
