...
from coffice.addons.test_mail.data import test_mail_data
from coffice.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from coffice.addons.test_mail.models.test_mail_models import MailTestGateway
from coffice.addons.test_mail.tests.common import BaseFunctionalTest, MockEmails
from coffice.addons.test_mail.tests.common import mail_new_test_user
from coffice.tests import tagged
from coffice.tools import email_split_and_format, mute_logger, pycompat, formataddr
...
class TestMailgateway(BaseFunctionalTest, MockEmails):
    ...
    @mute_logger('coffice.addons.mail.models.mail_thread', 'coffice.models')
    ...
    @mute_logger('coffice.addons.mail.models.mail_thread')
    ...
    @mute_logger('coffice.addons.mail.models.mail_thread', 'coffice.models.unlink', 'coffice.addons.mail.models.mail_mail')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by coffice should update thread accordingly """
    ...
    @mute_logger('coffice.addons.mail.models.mail_thread', 'coffice.models', 'coffice.addons.mail.models.mail_mail')
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # Coffice 10 update: compat mode has been removed and should not work anymore
