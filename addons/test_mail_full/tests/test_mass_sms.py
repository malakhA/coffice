...
from coffice.addons.phone_validation.tools import phone_validation
from coffice.addons.mass_mailing_sms.tests import common as mass_mailing_sms_common
from coffice.addons.test_mail.tests import common as test_mail_common
