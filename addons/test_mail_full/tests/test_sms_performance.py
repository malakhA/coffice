...
from coffice.addons.test_mail.tests.test_performance import BaseMailPerformance
from coffice.tests.common import users, warmup
...
class TestSMSPerformance(BaseMailPerformance, sms_common.MockSMS):
    ...
    @mute_logger('coffice.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
