...
from coffice.addons.test_mass_mailing.tests.common import MassMailingCase
from coffice.addons.base.models.ir_config_parameter import IrConfigParameter
from coffice.tests.common import TransactionCase, users
