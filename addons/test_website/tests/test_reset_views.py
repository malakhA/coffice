...
class TestWebsiteResetViews(coffice.tests.HttpCase):
    ...
    @mute_logger('coffice.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('coffice.addons.http_routing.models.ir_http', 'coffice.addons.website.models.ir_ui_view')
