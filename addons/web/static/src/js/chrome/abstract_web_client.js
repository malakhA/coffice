coffice.define('web.AbstractWebClient', function (require) {
"use strict";
...
var AbstractWebClient = Widget.extend(ServiceProviderMixin, KeyboardNavigationMixin, {
    ...
    init: function (parent) {
        // a flag to determine that coffice is fully loaded
        coffice.isReady = false;
        this.client_options = {};
        this._super(parent);
        ...
        this.set('title_part', {"zopenerp": "Coffice"});
    },
    start: function () {
        var self = this;
