coffice.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that Coffice actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute Coffice actions, given as an ID in
     ...
     * @param {CofficeEvent} ev.data.controllerID
     */
