coffice.define('web.ReportActionManager', function (require) {
"use strict";

/**
 * The purpose of this file is to add the support of Coffice actions of type
...
var WKHTMLTOPDF_MESSAGES = {
    ...
    workers: _lt('You need to start Coffice with at least two workers to print a pdf version of ' +
                 'the reports.'),
};
