coffice.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Coffice.
 *
 * The basic concurrency primitives in Coffice JS are the callback, and the
...
return {
    ...
    /**
     * A (Coffice) mutex is a primitive for serializing computations.  This is
