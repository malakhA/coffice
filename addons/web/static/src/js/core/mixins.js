coffice.define('web.mixins', function (require) {
"use strict";
...
function CofficeEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
CofficeEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

CofficeEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new CofficeEvent(this, name, info);
