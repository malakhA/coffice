(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = coffice.__DEBUG__.services['web.AbstractController'];
        var Discuss = coffice.__DEBUG__.services['mail.Discuss'];
        var WebClient = coffice.__DEBUG__.services["web.WebClient"];
    ...
    function _clickEverywhere(menu_id){
        ...
        testedApps = [];
        testedMenus = [];
        var isEnterprise = coffice.session_info.server_version_info[5] === 'e';
        // finding applications menus
        var $listOfAppMenuItems;
        if (isEnterprise) {
            console.log("Coffice flavor: Enterprise");
            ...
            console.log("Coffice flavor: Community");
            if (menu_id !== undefined) {
