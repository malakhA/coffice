coffice.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. Coffice JS views are the
 ...
 * the word 'view' has historical significance in Coffice code, so we replaced the
