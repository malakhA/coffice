coffice.define('web.search_bar_autocomplete_sources_registry', function (require) {
"use strict";
...
coffice.define('web._search_bar_autocomplete_sources_registry', function(require) {
"use strict";
