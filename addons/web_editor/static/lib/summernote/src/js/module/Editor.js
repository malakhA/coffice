define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // COFFICE: allow access for override
    this.table = table;   // COFFICE: allow access for override
    this.typing = typing; // COFFICE: allow access for override
    this.bullet = bullet; // COFFICE: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // COFFICE: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // COFFICE: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // COFFICE: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // COFFICE: addition
        $(anchor).css(linkInfo.style || {}); // COFFICE: addition
        if (isNewWindow) {
