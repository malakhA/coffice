coffice.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in coffice.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" coffice domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in coffice.
 */
...
/**
 * Let users choose a document, including uploading a new document in coffice.
 */
