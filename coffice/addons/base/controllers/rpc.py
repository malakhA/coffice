...
from coffice.http import Controller, dispatch_rpc, request, route
from coffice.service import wsgi_server
from coffice.fields import Date, Datetime


class CofficeMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = CofficeMarshaller
