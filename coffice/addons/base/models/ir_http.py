...
import coffice
from coffice import api, http, models, tools, SUPERUSER_ID
from coffice.exceptions import AccessDenied, AccessError
from coffice.http import request, content_disposition
from coffice.tools import consteq, pycompat
from coffice.tools.mimetypes import guess_mimetype
from coffice.modules.module import get_resource_path, get_module_path

from coffice.http import ALLOWED_DEBUG_MODES
from coffice.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(coffice.conf.server_wide_modules)
            if tools.config['test_enable'] and coffice.modules.module.current_test:
                installed.add(coffice.modules.module.current_test)
