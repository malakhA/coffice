...
from coffice import api, fields, models, SUPERUSER_ID, tools,  _
from coffice.exceptions import AccessError, UserError, ValidationError
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in coffice.modules.loading.
        if not self._context.get(MODULE_UNINSTALL_FLAG):
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Coffice
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Coffice many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Coffice
