...
from coffice import api, models, tools
from coffice.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
...
from coffice.addons.base.models.qweb import QWeb, Contextifier
from coffice.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from coffice.addons.web.controllers.main import module_boot
