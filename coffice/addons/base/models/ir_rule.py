...
from coffice.exceptions import AccessError, ValidationError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - coffice/addons/test_access_rights/tests/test_feedback.py
        # - coffice/addons/test_access_rights/tests/test_ir_rules.py
        # - coffice/addons/base/tests/test_orm.py (/home/dle/src/coffice/master-nochange-fp/coffice/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
