...
from coffice.tests.common import TransactionCase, BaseCase
from coffice.tools import mute_logger
from coffice.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('coffice.tools.safe_eval')
