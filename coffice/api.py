...
"""The COffice API module defines COffice Environments and method decorators.
...
from coffice.tools import frozendict, classproperty, lazy_property, StackMap
from coffice.exceptions import CacheMiss
...
def constrains(*args):
    ...
    Should raise :exc:`~coffice.exceptions.ValidationError` if the
    validation failed.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/coffice/coffice/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~coffice.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~coffice.addons.base.models.res_users`"""
...
from coffice.exceptions import UserError, AccessError, MissingError
