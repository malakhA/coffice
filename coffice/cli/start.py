...
from coffice.modules.module import get_module_root, MANIFEST_NAMES
from coffice.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the COffice server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            coffice.tools.config['init']['base'] = True
