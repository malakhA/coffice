# -*- coding: utf-8 -*-
"""
Test various crap patterns found in Coffice code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    coffice.define('mod2', function (require) {
