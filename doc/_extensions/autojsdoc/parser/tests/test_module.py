...
def test_single():
     ...
     */
    coffice.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    coffice.define('module1', function (req) {
        return 1;
    });
    coffice.define('module2', function (req) {
        return req('dep2');
    });
    coffice.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_func():
    [mod] = parse("""
    coffice.define('module', function (d) {
        /**
...
def test_hoist():
    [mod] = parse("""
    coffice.define('module', function() {
        return foo;
        /**
         * @param a_thing
         */
...
def test_export_instance():
    [mod] = parse("""
    coffice.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    coffice.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    coffice.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    coffice.define('m', function (require) {
        var Class = require('Class');
        /** local class */
