# Sign the COffice CLA

In order for your contribution to COffice to be accepted, you have to sign the
COffice Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [coffice/coffice](/coffice/coffice), adding a new file `<github-login>.md` under the
...
3. An COffice R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [coffice/coffice](/coffice/coffice), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is COffice, the file would be
    `doc/cla/corporate/coffice.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the COffice Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `coffice.com`.  In that case someone from the COffice team will
make the pull request on your behalf.

* Printable COffice CCLA v1.0 https://www.coffice.com/files/legal/COffice-CCLA-v1.0.pdf
* Printable COffice ICLA v1.0 https://www.coffice.com/files/legal/COffice-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for COffice is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the COffice project

* protect the COffice project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the COffice project and its users from bad actors who would contribute
...
contributor really intended to contribute to the COffice project under specific
...
The COffice CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, COffice S.A. to use, modify and
...
(ICLA) of COffice.  The agreement is executed by adding your name and
...
removed from the COffice project.
