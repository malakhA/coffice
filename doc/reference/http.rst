...
:class:`~coffice.models.Model`, but can't use the same mechanism as the
...
Controllers are created by :ref:`inheriting <python:tut-inheritance>` from :class:`~coffice.http.Controller`.
Routes are defined through methods decorated with :func:`~coffice.http.route`::
...
* decorating with :func:`~coffice.http.route` is necessary to keep the method
...
.. autofunction:: coffice.http.route
...
The request object is automatically set on :data:`coffice.http.request` at
the start of the request

.. autoclass:: coffice.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: coffice.http.HttpRequest
    :members:
.. autoclass:: coffice.http.JsonRequest
    :members:

Response
--------

.. autoclass:: coffice.http.Response
    :members:
    :member-order: bysource
