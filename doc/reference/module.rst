...
The manifest file serves to declare a python package as an COffice module
...
``category`` (``str``, default: ``Uncategorized``)
    classification category within COffice, rough business domain for the module.
...
``depends`` (``list(str)``)
    COffice modules which must be loaded before this one, either because this
...
.. _existing categories:
     https://github.com/coffice/coffice/blob/13.0/coffice/addons/base/data/ir_module_category_data.xml
