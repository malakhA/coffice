...
Aside from manually managing access using custom code, COffice provides two main
...
An ORM :class:`~coffice.fields.Field` can have a ``groups`` attribute
...
* restricted fields are removed from :meth:`~coffice.models.Model.fields_get`
  responses
