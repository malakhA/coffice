...
Step 2: Configure the coffice instance with your zone
--------------------------------------------------

In the COffice back end, go to the :guilabel:`Website Settings`: menu, then
...
.. image:: cdn/coffice_cdn_base_url.png
   :class: img-responsive
...
.. image:: cdn/coffice_check_your_html.png
   :class: img-responsive
...
resulting problem on a default COffice website will be the lack of font-awesome
...
.. image:: cdn/coffice_font_file_not_loaded.png
   :class: img-responsive

A security error message will also appear in the browser's console:

.. image:: cdn/coffice_security_message.png
   :class: img-responsive
