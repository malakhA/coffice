...
* Enter your COffice Enterprise Subscription code
...
* Stop the coffice service

  .. code-block:: console

    $ sudo service coffice stop
...
* Update your database to the enterprise packages using
  ...
  .. code-block:: console
    ...
    $ python3 /usr/bin/coffice-bin -d <database_name> -i web_enterprise --stop-after-init

* You should be able to connect to your COffice Enterprise instance using your usual mean of identification.
  You can then link your database with your COffice Enterprise Subscription by entering the code you received
...
* Restart your server with the updated addons path of point 3.
  ...
  COffice Enterprise Subscription by entering the code you received by e-mail in the form input
...
* Uninstall COffice Community (using the Uninstall executable in the installation folder) -
  PostgreSQL will remain installed

  .. image:: enterprise/windows_uninstall.png
    :class: img-responsive

* Launch the COffice Enterprise Installer and follow the steps normally. When choosing
  ...
  Uncheck ``Start COffice`` at the end of the installation

  .. image:: enterprise/windows_setup.png
   :class: img-responsive

* Using a command window, update your COffice Database using this command (from the COffice
  installation path, in the server subfolder)

  .. code-block:: console

    $ coffice.exe -d <database_name> -i web_enterprise --stop-after-init

* No need to manually launch the server, the service is running.
  You should be able to connect to your COffice Enterprise instance using your usual
  mean of identification. You can then link your database with your COffice Enterprise
